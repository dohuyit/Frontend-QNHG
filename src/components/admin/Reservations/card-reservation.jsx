...
const ReservationCard = ({
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <Badge type={config.type} className="mb-2">
        {config.text}
      </Badge>
    );
  };
              ...
              <div className="ms-4">
                {reservation.status === "pending" && onTimeChange ? (
                  <input
                    ...
                    onChange={(e) =>
                      onTimeChange(reservation.id, e.target.value)
                    }
                    min={(() => {
          ...
          <Row>
            <Col md={12} className="mb-3">
              <div className="d-flex align-items-center mb-2">
                ...
                />
                <small
                  style={{ color: "#ff9800", fontWeight: 600, fontSize: 15 }}
                >
                  Ghi chú :
                </small>
              </div>
              <div>
                {reservation.notes || reservation.special_requests ? (
                  <div
                    style={{
                      background:
                        "linear-gradient(90deg, #fffde4 0%, #ffe9c7 100%)",
