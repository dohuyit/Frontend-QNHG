...
import { softDeleteCombo, updateCombo } from "@services/admin/comboService";
  ...
  return (
    <>
      ...
      <Modal isOpen={showDelete} toggle={() => setShowDelete(false)}>
        ...
        <ModalBody>
          Bạn có chắc chắn muốn xóa combo <strong>{selectedItem?.name}</strong>{" "}
          không?
        </ModalBody>
        <ModalFooter>
                  ...
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        const selectedDishes = dishList.filter((d) =>
                          selectedOptions.includes(d.id)
                        );
